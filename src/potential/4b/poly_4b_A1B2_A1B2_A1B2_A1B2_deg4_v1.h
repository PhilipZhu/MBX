...
#ifndef POLY_4B_MBNRG_A1B2_A1B2_A1B2_A1B2_DEG4_H
#define POLY_4B_MBNRG_A1B2_A1B2_A1B2_A1B2_DEG4_H

/**
 * @file poly_4b_A1B2_A1B2_A1B2_A1B2_deg4_v1.h
 * @brief Contains the structure of the polynomial for symmetry A1B2_A1B2_A1B2_A1B2
 */
...
struct poly_A1B2_A1B2_A1B2_A1B2_deg4_v1 {
...
#endif // POLY_4B_MBNRG_A1B2_A1B2_A1B2_A1B2_DEG4_H
...
//  add_variable['A', '1', 'a', 'A', '4', 'd', 'x-inter-A+A-0']
...
//  add_variable['A', '1', 'a', 'B', '7', 'd', 'x-inter-A+B-0']
//  add_variable['A', '1', 'a', 'B', '8', 'd', 'x-inter-A+B-0']
//  add_variable['A', '2', 'b', 'A', '3', 'c', 'x-inter-A+A-0']
//  add_variable['A', '2', 'b', 'A', '4', 'd', 'x-inter-A+A-0']
...
//  add_variable['A', '2', 'b', 'B', '7', 'd', 'x-inter-A+B-0']
//  add_variable['A', '2', 'b', 'B', '8', 'd', 'x-inter-A+B-0']
//  add_variable['A', '3', 'c', 'A', '4', 'd', 'x-inter-A+A-0']
...
//  add_variable['A', '3', 'c', 'B', '7', 'd', 'x-inter-A+B-0']
//  add_variable['A', '3', 'c', 'B', '8', 'd', 'x-inter-A+B-0']
//  add_variable['A', '4', 'd', 'B', '1', 'a', 'x-inter-A+B-0']
//  add_variable['A', '4', 'd', 'B', '2', 'a', 'x-inter-A+B-0']
//  add_variable['A', '4', 'd', 'B', '3', 'b', 'x-inter-A+B-0']
//  add_variable['A', '4', 'd', 'B', '4', 'b', 'x-inter-A+B-0']
//  add_variable['A', '4', 'd', 'B', '5', 'c', 'x-inter-A+B-0']
//  add_variable['A', '4', 'd', 'B', '6', 'c', 'x-inter-A+B-0']
//  add_variable['A', '4', 'd', 'B', '7', 'd', 'x-intra-A+B-1']
//  add_variable['A', '4', 'd', 'B', '8', 'd', 'x-intra-A+B-1']
...
//  add_variable['B', '1', 'a', 'B', '7', 'd', 'x-inter-B+B-0']
//  add_variable['B', '1', 'a', 'B', '8', 'd', 'x-inter-B+B-0']
...
//  add_variable['B', '2', 'a', 'B', '7', 'd', 'x-inter-B+B-0']
//  add_variable['B', '2', 'a', 'B', '8', 'd', 'x-inter-B+B-0']
//  add_variable['B', '3', 'b', 'B', '4', 'b', 'x-intra-B+B-1']
//  add_variable['B', '3', 'b', 'B', '5', 'c', 'x-inter-B+B-0']
//  add_variable['B', '3', 'b', 'B', '6', 'c', 'x-inter-B+B-0']
//  add_variable['B', '3', 'b', 'B', '7', 'd', 'x-inter-B+B-0']
//  add_variable['B', '3', 'b', 'B', '8', 'd', 'x-inter-B+B-0']
//  add_variable['B', '4', 'b', 'B', '5', 'c', 'x-inter-B+B-0']
//  add_variable['B', '4', 'b', 'B', '6', 'c', 'x-inter-B+B-0']
//  add_variable['B', '4', 'b', 'B', '7', 'd', 'x-inter-B+B-0']
//  add_variable['B', '4', 'b', 'B', '8', 'd', 'x-inter-B+B-0']
//  add_variable['B', '5', 'c', 'B', '6', 'c', 'x-intra-B+B-1']
//  add_variable['B', '5', 'c', 'B', '7', 'd', 'x-inter-B+B-0']
//  add_variable['B', '5', 'c', 'B', '8', 'd', 'x-inter-B+B-0']
//  add_variable['B', '6', 'c', 'B', '7', 'd', 'x-inter-B+B-0']
//  add_variable['B', '6', 'c', 'B', '8', 'd', 'x-inter-B+B-0']
