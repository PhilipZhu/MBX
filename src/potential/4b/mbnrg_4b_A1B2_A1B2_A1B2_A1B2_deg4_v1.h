...
#ifndef MBNRG_4B_A1B2_A1B2_A1B2_A1B2_DEG4_V1_H
#define MBNRG_4B_A1B2_A1B2_A1B2_A1B2_DEG4_V1_H
...
/**
 * @file mbnrg_4b_A1B2_A1B2_A1B2_A1B2_deg4_v1.h
 * @brief Contains the structure of the polynomial holder for symmetry A1B2_A1B2_A1B2_A1B2
 */

/**
 * @namespace mbnrg_A1B2_A1B2_A1B2_A1B2_deg4
 * @brief Encloses the structure of the polynomial holder for symmetry A1B2_A1B2_A1B2_A1B2
 */
...
struct mbnrg_A1B2_A1B2_A1B2_A1B2_deg4_v1 {
    // Creates an empty class
    mbnrg_A1B2_A1B2_A1B2_A1B2_deg4_v1() {};
     ...
     * @param[in] mon3 Monomer id of the first monomer of interest

     */
    mbnrg_A1B2_A1B2_A1B2_A1B2_deg4_v1(const std::string mon1, const std::string mon2, const std::string mon3, const std::string mon4);

    // Destroys the class
    ~mbnrg_A1B2_A1B2_A1B2_A1B2_deg4_v1() {};
    
    // Polynomial for this symmetry
    typedef poly_A1B2_A1B2_A1B2_A1B2_deg4_v1 polynomial;
...
urns a vector with them.
     ...
     * @param[in] xyz3 Pointer to a double array with the coordinates of monomer 3 of the n-mer.
     
     * @param[in] n Number of monomers passed in the xyz array.
     * @return Double with the energy.
     */
    double eval(const double *xyz1, const double *xyz2, const double *xyz3, const double *xyz4, const size_t n);
...
urns a vector with them.
     ...
     * @param[out] grad3 Pointer to a double array with the gradients of monomer 3 of the n-mer.
    
     * @param[in] n Number of monomers passed in the xyz array.
     * @return Double with the energy.
     */
    double eval(const double *xyz1, const double *xyz2, const double *xyz3, const double *xyz4, double *grad1, double *grad2, double *grad3, double *grad4 , const size_t n, std::vector<double> *virial=0);
