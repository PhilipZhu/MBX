...
double get_3b_energy(std::string mon1, std::string mon2, std::string mon3, size_t nm, std::vector<double> xyz1,
    ...
    } else if ( mon1.size() >= 8 && mon1.compare(0, 5, "h2o_2") == 0 && mon1.compare(6, 2, "3c") == 0
                and  mon1 == mon2
                and  mon1 == mon3 ) {
    ...
    } else if ( mon1.size() >= 8 && mon1.compare(0, 5, "h2o_2") == 0 && mon1.compare(6, 2, "3b") == 0
                and  mon1 == mon2
                and  mon1 == mon3 ) {
    ...
    } else if ( mon1.size() >= 8 && mon1.compare(0, 5, "h2o_2") == 0 && mon1.compare(6, 2, "3a") == 0
                and  mon1 == mon2
                and  mon1 == mon3 ) {
