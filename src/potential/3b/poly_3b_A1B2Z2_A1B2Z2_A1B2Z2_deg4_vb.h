...
#ifndef POLY_3B_MBNRG_A1B2Z2_A1B2Z2_A1B2Z2_DEG4_VB_H
#define POLY_3B_MBNRG_A1B2Z2_A1B2Z2_A1B2Z2_DEG4_VB_H

/**
 * @file poly_3b_A1B2Z2_A1B2Z2_A1B2Z2_deg4_vb.h
 * @brief Contains the structure of the polynomial for symmetry A1B2Z2_A1B2Z2_A1B2Z2
 */

/**
 * @namespace mbnrg_A1B2Z2_A1B2Z2_A1B2Z2_deg4
 * @brief Encloses the structure of the polynomial for symmetry A1B2Z2_A1B2Z2_A1B2Z2
 */

namespace mbnrg_A1B2Z2_A1B2Z2_A1B2Z2_deg4 {

struct poly_A1B2Z2_A1B2Z2_A1B2Z2_deg4_vb {
    // Degree of the polynomial
    static const unsigned degree = 4;

    // Number of variables
    static const unsigned n_vars = 84;

    // Number of terms
    static const unsigned size = 1804;

    /**
     * @brief Evaluates the polynomial of degree 4 for A1B2Z2_A1B2Z2_A1B2Z2 symmetry.
     *
     * Given the linear parameters and the value of the polynomial variables, 
     * evaluates the polynomial for the A1B2Z2_A1B2Z2_A1B2Z2 symmetry.
     * @param[in] x Double array of length 84 with the variable values
     * @param[in] a Double array of 1804 elements with the linear parameters of the polynomial
     * @return Value of the polynomial
     */
    double eval(const double x[84],
              const double a[1804]);
     ...
     * @return Value of the polynomial
     */
    double eval_direct(const double x[84],
                     const double a[1804]);
     ...
     * @param[in] x Double array of length 84 with the variable values
     * @param[in] a Double array of 1804 elements with the linear parameters of the polynomial
     * @param[out] g Double array of length 84 that will store the gradients dP/dxi
     * @return Value of the polynomial
     */
    double eval(const double x[84],
              const double a[1804],
...
#endif // POLY_3B_MBNRG_A1B2Z2_A1B2Z2_A1B2Z2_DEG4_H
...
//  add_variable['A', '1', 'a', 'Z', '5', 'c', 'x-inter-A+Z-0']
//  add_variable['A', '1', 'a', 'Z', '6', 'c', 'x-inter-A+Z-0']
...
//  add_variable['A', '2', 'b', 'Z', '5', 'c', 'x-inter-A+Z-0']
//  add_variable['A', '2', 'b', 'Z', '6', 'c', 'x-inter-A+Z-0']
...
//  add_variable['A', '3', 'c', 'Z', '1', 'a', 'x-inter-A+Z-0']
//  add_variable['A', '3', 'c', 'Z', '2', 'a', 'x-inter-A+Z-0']
//  add_variable['A', '3', 'c', 'Z', '3', 'b', 'x-inter-A+Z-0']
//  add_variable['A', '3', 'c', 'Z', '4', 'b', 'x-inter-A+Z-0']
...
//  add_variable['B', '1', 'a', 'Z', '5', 'c', 'x-inter-B+Z-0']
//  add_variable['B', '1', 'a', 'Z', '6', 'c', 'x-inter-B+Z-0']
...
//  add_variable['B', '2', 'a', 'Z', '5', 'c', 'x-inter-B+Z-0']
//  add_variable['B', '2', 'a', 'Z', '6', 'c', 'x-inter-B+Z-0']
...
//  add_variable['B', '3', 'b', 'Z', '5', 'c', 'x-inter-B+Z-0']
//  add_variable['B', '3', 'b', 'Z', '6', 'c', 'x-inter-B+Z-0']
...
//  add_variable['B', '4', 'b', 'Z', '5', 'c', 'x-inter-B+Z-0']
//  add_variable['B', '4', 'b', 'Z', '6', 'c', 'x-inter-B+Z-0']
//  add_variable['B', '5', 'c', 'B', '6', 'c', 'x-intra-B+B-1']
//  add_variable['B', '5', 'c', 'Z', '1', 'a', 'x-inter-B+Z-0']
//  add_variable['B', '5', 'c', 'Z', '2', 'a', 'x-inter-B+Z-0']
//  add_variable['B', '5', 'c', 'Z', '3', 'b', 'x-inter-B+Z-0']
//  add_variable['B', '5', 'c', 'Z', '4', 'b', 'x-inter-B+Z-0']
//  add_variable['B', '6', 'c', 'Z', '1', 'a', 'x-inter-B+Z-0']
//  add_variable['B', '6', 'c', 'Z', '2', 'a', 'x-inter-B+Z-0']
//  add_variable['B', '6', 'c', 'Z', '3', 'b', 'x-inter-B+Z-0']
//  add_variable['B', '6', 'c', 'Z', '4', 'b', 'x-inter-B+Z-0']
//  add_variable['Z', '1', 'a', 'Z', '3', 'b', 'x-inter-Z+Z-0']
//  add_variable['Z', '1', 'a', 'Z', '4', 'b', 'x-inter-Z+Z-0']
//  add_variable['Z', '1', 'a', 'Z', '5', 'c', 'x-inter-Z+Z-0']
//  add_variable['Z', '1', 'a', 'Z', '6', 'c', 'x-inter-Z+Z-0']
//  add_variable['Z', '2', 'a', 'Z', '3', 'b', 'x-inter-Z+Z-0']
//  add_variable['Z', '2', 'a', 'Z', '4', 'b', 'x-inter-Z+Z-0']
//  add_variable['Z', '2', 'a', 'Z', '5', 'c', 'x-inter-Z+Z-0']
//  add_variable['Z', '2', 'a', 'Z', '6', 'c', 'x-inter-Z+Z-0']
//  add_variable['Z', '3', 'b', 'Z', '5', 'c', 'x-inter-Z+Z-0']
//  add_variable['Z', '3', 'b', 'Z', '6', 'c', 'x-inter-Z+Z-0']
//  add_variable['Z', '4', 'b', 'Z', '5', 'c', 'x-inter-Z+Z-0']
//  add_variable['Z', '4', 'b', 'Z', '6', 'c', 'x-inter-Z+Z-0']
//  
//  add_filter['sum-degree', 'x-inter-*+*-*', '0']
//  add_filter['poorly-behaved-by-fragment']
//  add_filter['sum-degree', '*', '3+', 'and', 'poorly-behaved']
//  add_filter['sum-degree', '*', '3+', 'and', 'sum-degree', 'x-inter-X+X-*', '2+']
//  add_filter['sum-degree', '*', '3+', 'and', 'sum-degree', 'x-intra-A+B-*', '2+']
//  add_filter['sum-degree', '*', '3+', 'and', 'sum-degree', 'x-inter-A+B-*', '2+']
//  add_filter['sum-degree', '*', '3+', 'and', 'sum-degree', 'x-inter-B+B-*', '2+']
//  add_filter['sum-degree', '*', '3+', 'and', 'sum-degree', 'x-intra-B+B-*', '2+']
//  add_filter['sum-degree', '*', '3+', 'and', 'sum-degree', 'x-inter-A+A-*', '1+']
